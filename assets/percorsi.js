            ...
            onEachFeature: function(feature, layer) {
                layer.on('click', function(e) {
                    ...
                    if (selectedLayer !== layer) {
                        ...
                        populateResults(feature.properties.id, feature.properties.id, "city-results", cityCurrentPage, cityResults)
             ...
             onEachFeature: function(feature, layer) {
                layer.on('click', function(event) {
                    if (selectedRegionMarker !== layer) {
                        ...
                        populateResults(feature.properties.id, feature.properties.id, "region-results", regionCurrentPage, regionResults)
